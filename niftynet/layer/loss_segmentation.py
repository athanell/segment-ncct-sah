...
def dice_plus_xent_loss(prediction, ground_truth, dice_epsilon, weight_map=None):
    """
    ...
    loss_dice = dice(softmax_of_logits, ground_truth, dice_epsilon, weight_map=weight_map)
...
def dice(prediction, ground_truth, dice_epsilon, weight_map=None):
    """
    ...
    one_hot = tf.sparse.slice(one_hot, [0, 1], prediction.shape)
    ...
    dice_score = (dice_numerator + dice_epsilon) / (dice_denominator + dice_epsilon)
    # dice_score.set_shape([num_classes])
    # minimising (1 - dice_coefficients)
    return 1.0 - tf.reduce_mean(dice_score)


def dice_nosquare(prediction, ground_truth, dice_epsilon, weight_map=None):
    """
...
def tversky(prediction, ground_truth, dice_epsilon, weight_map=None, alpha=0.3, beta=0.7):
    """
    ...
    numerator = tp + dice_epsilon
    denominator = tp + fp + fn + dice_epsilon
    score = numerator / denominator
    return 1.0 - tf.reduce_mean(score)


def dice_dense(prediction, ground_truth, dice_epsilon, weight_map=None):
    """
...
def dice_dense_nosquare(prediction, ground_truth, dice_epsilon, weight_map=None):
    """
