...
class ChannelSparseBNLayer(niftynet.layer.bn.BNLayer):
    ...
    def layer_op(self, inputs, is_training, mask, use_local_stats=False):
        ...
        tf.add_to_collection(tf.compat.v1.GraphKeys.UPDATE_OPS, update_moving_mean)
        tf.add_to_collection(tf.compat.v1.GraphKeys.UPDATE_OPS, update_moving_variance)
