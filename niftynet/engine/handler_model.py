...
class ModelRestorer(object):
    ...
    def restore_model(self, _sender, **_unused):
        ...
        to_restore = None  # tf.compat.v1.train.Saver's default value, restoring all
...
class ModelSaver(object):
    ...
    def _save_at(self, iter_i):
        ...
        self.saver.save(sess=tf.compat.v1.get_default_session(),
                        ...
                        global_step=iter_i)
        tf.compat.v1.logging.info('Model iteration {} saved: {}-{}'.format(iter_i, self.file_name_prefix, iter_i))
