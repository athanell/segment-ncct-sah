...
class OutputsCollector(object):
    """
    Collect all tf.Tensor object, to be evaluated by tf.compat.v1.Session.run()
    ...
    def add_to_collection(self,
        ...
        :param var: tf.Tensor to be evaluated by tf.compat.v1.Session()
    ...
    def variables(self, collection=CONSOLE):
        """
        get tf.Tensors to be evaluated by tf.compat.v1.Session().run()
    ...
    def _average_variables_over_devices(var_dict, create_tf_summary_op=False):
        ...
        for var_name in var_dict:
            ...
            if create_tf_summary_op:
                ...
                tf.compat.v1.summary.scalar(name='{}_device_average_'.format(var_name),
